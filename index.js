		...
		client.query(queryForSQL, function(err, result) {
				...
				testSQlValue.forEach(function(value){
					...
					markit.getQuote(ticker, function(err, data) {
						...
						graphDataElement.Elements[0].Symbol = graphDataElementName;
						graphDataElement.Elements[0].Type = "price";
						graphDataElement.Elements[0].Params = '["c"]';
						//.push('{"Symbol":"'+graphDataElementName+'","Type":"price","Params":["c"]}');
