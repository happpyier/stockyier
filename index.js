	...
	pg.connect(process.env.DATABASE_URL, function(err, client, done) {
		client.query(queryForSQL, function(err, result) {
				...
				testSQlValue.forEach(function(value){
					...
					response.write("<div class='ticker'> <boldHeader >" + ticker + "</boldHeader> <button class='borderless' value='"+ticker+"' onclick='removeTicker(this)'>x</button> <br/><br/>" + tickerName + "(" + ticker + ") Prices, 	Dividends, Splits and Trading Volume </div>");
				});
