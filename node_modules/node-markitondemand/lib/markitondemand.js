...
var baseUrl = "http://dev.markitondemand.com/MODApis/Api/v2";
...
var getInteractive = function getInteractive(symbol, next) {
  if (!symbol || typeof symbol !== 'string') return next("Invalid symbol");

  var url = baseUrl + "/InteractiveChart/json?parameters=" + symbol;
  _getRequest(url, next);
};
...
module.exports.getQuotes = getInteractive;
